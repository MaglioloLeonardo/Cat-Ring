...
import App.BusinessLogic.EventManagement.EventInfo;
import App.BusinessLogic.EventManagement.ServiceInfo;
...
public class TestCatERingMenu {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("\nTEST EDIT TITLE");
            CatERing.getInstance().getMenuManager().changeTitle("Il mio nuovo menù");
            System.out.println(m.testString());
